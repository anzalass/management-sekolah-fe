...
import { KonselingCellActionMengajar } from './cell-action-mengajar';
...
export const columnsMengajar: ColumnDef<Konseling>[] = [
  {
  ...
  },
  {
    id: 'actions',
    header: 'Actions',
    cell: ({ row }) => <KonselingCellActionMengajar data={row.original} />
  }
];
