...
import KonselingFormMengajar from './konseling-form-mengajar';

type IDKonselingType = {
  id: string;
};

export default async function KonselingViewPageMengajar({
  id
}: IDKonselingType) {
  ...
  return (
    <KonselingFormMengajar
      id={id}
      initialData={KonselingData}
      pageTitle={pageTitle}
    />
  );
}
