...
import { PelanggaranPrestasiCellActionMengajar } from './cell-action-mengajar';
...
export const columnsMengajar: ColumnDef<PelanggaranPrestasi>[] = [
  {
    accessorKey: 'Siswa',
    header: 'Nama Siswa',
  ...
  },
  {
    ...
    header: 'Actions',
    cell: ({ row }) => (
      <PelanggaranPrestasiCellActionMengajar data={row.original} />
    )
  }
];
