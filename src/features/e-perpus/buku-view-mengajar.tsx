...
import BukuFormMengajar from './data-buku-form-mengajar';

type IDBukuType = {
  id: string;
};

export default async function BukuViewPageMengajar({ id }: IDBukuType) {
  let BukuData = null;
  ...
  return (
    <BukuFormMengajar id={id} initialData={BukuData} pageTitle={pageTitle} />
  );
}
