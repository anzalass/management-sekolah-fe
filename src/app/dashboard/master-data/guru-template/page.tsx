...
import GuruTemplateListingPage from '@/features/guru-template/guru-template-listing';
import GuruTemplateTableAction from '@/features/guru-template/guru-template-tables/guru-template-table-action';
