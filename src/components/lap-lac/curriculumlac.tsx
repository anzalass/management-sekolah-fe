...
const learningPrinciples = [
  {
    key: 'E',
    text: 'Learning through exploration and questioning',
    color: 'from-red-500 to-pink-500'
  },
  {
    key: 'I',
    text: 'Integrated learning across subject areas',
    color: 'from-orange-500 to-red-500'
  },
  {
    key: 'S',
    text: 'Students take active ownership of learning',
    color: 'from-yellow-500 to-orange-500'
  },
  {
    key: 'R',
    text: 'Learning connected to real-life experiences',
    color: 'from-green-500 to-emerald-500'
  },
  {
    key: 'G',
    text: 'Developing global awareness and respect',
    color: 'from-blue-500 to-cyan-500'
  }
];

export function CurriculumLacSection({
  refCurriculum,
  inViewCurriculum
}: Props) {
  return (
            ...
            <div className='space-y-6'>
              <div className='rounded-2xl bg-white p-6 shadow-lg'>
                <h3 className='mb-4 text-base font-bold text-blue-900 md:text-2xl'>
                  Focusing on inquiry based learning and international
                  mindedness through a transdisciplinary approach{' '}
                </h3>
